...
class usm_bdu_dcu: usm_bdu_wdl
	...
	// {
		// author = "Delta Hawk";
		// displayName = "BDUs, trousers/blouse, DCU (U.S.M.C.)";
		// picture = "\us_military_uniforms\icons\pic_bdu_dcu_m_ca.paa";
		// hiddenSelectionsTextures[] = {"us_military_uniforms\textures\uniform_bdu_dcu_m_co.paa"};
		...
		class usm_bdu_blk: usm_bdu_wdl
	{
		...
		// hiddenSelectionsTextures[] = {"us_military_uniforms\textures\uniform_bdu_blk_co.paa"};
		// class ItemInfo: ItemInfo
		// {
	...
	class usm_bdu_odg: usm_bdu_wdl
	{
		...
		// hiddenSelectionsTextures[] = {"us_military_uniforms\textures\uniform_bdu_odg_co.paa"};
		// class ItemInfo: ItemInfo
		// {
		...
		class usm_bdu_ubn: usm_bdu_wdl
	{
		...
		// hiddenSelectionsTextures[] = {"us_military_uniforms\textures\uniform_bdu_ubn_co.paa"};
		// class ItemInfo: ItemInfo
		// {
